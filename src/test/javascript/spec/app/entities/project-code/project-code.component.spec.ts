...
import { ProjectCodeComponent } from 'app/entities/project-code/project-code.component';
...
describe('Component Tests', () => {
    describe('ProjectCode Management Component', () => {
        let comp: ProjectCodeComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ProjectCodeComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.projectCodes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
