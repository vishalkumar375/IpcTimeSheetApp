    ...
    describe('TimeSheet Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/time-sheets';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a TimeSheet', () => {
                service.create(new TimeSheet(null)).subscribe(received => {
            ...
            it('should update a TimeSheet', () => {
                service.update(new TimeSheet(123)).subscribe(received => {
