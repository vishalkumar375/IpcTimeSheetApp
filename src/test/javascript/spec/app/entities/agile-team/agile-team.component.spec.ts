...
import { AgileTeamComponent } from 'app/entities/agile-team/agile-team.component';
...
describe('Component Tests', () => {
    describe('AgileTeam Management Component', () => {
        let comp: AgileTeamComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(AgileTeamComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.agileTeams[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
