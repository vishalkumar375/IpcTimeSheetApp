    ...
    describe('TaskType Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/task-types';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a TaskType', () => {
                service.create(new TaskType(null)).subscribe(received => {
            ...
            it('should update a TaskType', () => {
                service.update(new TaskType(123)).subscribe(received => {
